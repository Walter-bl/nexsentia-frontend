...
const TimelinePage = () => {
  ...
  // Filter events based on selected impact
  ...
  return (
    <div className="min-h-screen md:p-6 text-gray-300">
      ...
      <div className="space-y-4">
        {loading ? (
          <div className="py-20 text-center text-gray-500">Loading timeline...</div>
...
<div className="flex items-center gap-2">
  <Pill
    ...
    icon={
      <TrendingUp
        size={12}
        color={impactColorIcon[event.impactLevel].icon} // dynamic color
      />
    }
   width=""
    bgColor={impactColorIcon[event.impactLevel].bg} // subtle background
    textColor={impactColorIcon[event.impactLevel].text} // for text if any
    className="p-2"
  />
  <ChevronRight
    size={16}
    color={impactColorIcon[event.impactLevel].icon} // same color as Pill icon
  />
</div>
